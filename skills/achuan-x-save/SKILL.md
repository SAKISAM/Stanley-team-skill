...
name: achuan-x-save
description: |
  Achuan-X-OperationFlow 的状态保存模块。用于把当前 X/Twitter 新号起号状态、阶段判断、内容主题与目标读者、主页、内容节奏、增长问题、风险状态、数据复盘结果、账号成长档案和下一步动作保存成本地存档。
...
提取当前粉丝数、账号阶段、当前内容主题、目标读者、主页状态、内容节奏、增长问题、风险状态、收益状态、数据复盘摘要、执行评分、下一步 skill。
